...
namespace Compiler.Tokenization
{
    ...
    {
        // non-terminals
        IntLiteral, Identifier, Operator, CharLiteral, Parameter, PrimaryExpression,

        // reserved words - terminals
        Begin, Const, Do, Else, End, If, In, Let, Then, Var, While, Loop, Repeat,

        // punctuation - terminals (Becomes is for assignment (:=) , Is is for constants (~), This is for assignment (=>))
        Colon, Semicolon, Becomes, Is, LeftBracket, RightBracket, QuestionMark, This,
